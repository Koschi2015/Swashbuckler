...
public:
    //
    void Load(std::string Pfad,float size,sf::Text::Style style);
    //
    ...
    void Set_Text(sf::Text text) {Text = text;}
    //
    void Set_Size(float Size) {Text.setCharacterSize(Size);}
    //
    void Set_Color(sf::Color Color) {Text.setColor(Color);}
    //
    float Get_Size() {return Text.getCharacterSize();}
    //
    ...
    //
    sf::Text::Style Get_Style() {return static_cast<sf::Text::Style>(Text.getStyle());}
    //
...
private:
    ...
    // Funktions Pointer
    static const sf::Mouse* UI_InputHandle;
    //
...
public:
    ...
    //
    static void Set_Input(const sf::Mouse* Value) {UI_InputHandle = Value;}
    //
